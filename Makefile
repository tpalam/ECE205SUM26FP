...
SOURCES = main.cpp Game.cpp Player.cpp Platform.cpp Spike.cpp SawBlade.cpp FinishLine.cpp Level.cpp ObjectFactory.cpp Background.cpp SpeedBoost.cpp SlowDown.cpp ResourceManager.cpp Button.cpp
